  ...
  return (
    <div className="bg-main container-main">
      <div className="flex flex-row flex-wrap xl:flex-nowrap gap-6">
        <div className="flex flex-wrap md:flex-nowrap bg-secondary/10 rounded-[20px] px-[76px] py-[61px] justify-between xl:justify-start xl:gap-[155px] w-full xl:basis-3/4">
        ...
        <div className="flex flex-col bg-primary pl-10 pr-8 py-[42px] rounded-[20px] min-w-[444px] xl:basis-1/4">
      ...
      <div className="mt-9 pb-[69px]">
        <p className="font-normal text-base text-[#fff]">Ⓒ Scorefam 2022. All rights reserved</p>
      </div>
    </div>
  );
};
