  ...
  return (
    <div className="py-16 container-home bg-main">
      ...
      <div className="flex flex-wrap justify-between">
        <div className="rounded-[20px] card-gradient w-[332px] h-full bg-gradient-to-b from-[#ffffff33] to-[#ffffff00]">
          <Tuor />
          <h5 className="uppercase mt-8">GUIDED TOURS</h5>
          <p className="text-[#fff] text-base w-[277px] text-center mt-[14px]">
            To use an analogy that everyone can relate to, our seasoned team has
            “seen the movie” before.
          </p>
        </div>
        <div className="rounded-[20px] card-gradient w-[332px] h-full bg-gradient-to-b from-[#008a8133] to-[#ffffff00] mt-16">
          <Award />
